      ...
      <div className="container pt-80 text-center">
        ...
        <div className="max-w-[365px] mx-auto flex flex-col gap-5 mt-8">
          <div className="flex flex-col gap-5 md:gap-0 md:flex-row justify-between">
            <button className="px-3 py-3 border border-[#F7CA1580] bg-[#F7CA15]/10 rounded-[10px] font-Manrope font-bold text-base text-[#F7CA15]">
              Join Existing Duels
            </button>
          ...
          <button className="w-full py-3 border border-[#FFFFFF3B] bg-[#161616] rounded-[10px] font-Manrope font-bold text-base text-white">
            How to Participate
          </button>
        </div>
      </div>
