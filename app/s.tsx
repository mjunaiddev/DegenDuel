        ...
        >
          ...
          <div className="flex items-center justify-between px-6 py-4 border-b border-[#ffffff1a]">
            ...
            <h2 className="text-xl font-semibold text-white">
              {" "}
              Frequently Asked <span className="text-[#F5C400]">
                Questions
              </span>{" "}
            </h2>{" "}
            <button
          ...
          <div className="overflow-y-auto max-h-[65vh] px-4 py-4 space-y-3 custom-scroll">
            {faqData.map((faq, index) => (
              <div
                key={index}
                className="bg-[#2A2A2A] rounded-xl px-4 py-3 cursor-pointer"
          ...
          {/* Right yellow scroll indicator (visual like screenshot) */}{" "}
          <div className="absolute top-16 right-1 h-[120px] w-[3px] bg-[#F5C400] rounded-full" />{" "}
        </div>{" "}
      </div>{" "}
    </>
  );
