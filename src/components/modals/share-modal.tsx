...
const ShareModal = ({ onClose }: { onClose: () => void }) => {
  return (
    <div className="relative w-72 sm:w-96 md:w-[640px] border-2 border-[#36363699] rounded-lg bg-[#1C1C1C] p-10 text-white">
      <button
        onClick={onClose}
      ...
      <div className="md:w-[480px] flex flex-col gap-5 md:gap-10 mx-auto">
